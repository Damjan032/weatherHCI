        ...
        <div className="App">
            ...
            <section id="about" className="about">
                <div className="container">
                    ...
                    <div className="row d-flex justify-content-center">
                        <a width="150px" className="btn btn-outline-secondary scrollto custom" href="#services"
                           role="button">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;See
                            table&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a className="btn btn-outline-secondary scrollto" href="#graph"
                           role="button">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;See
                            graph&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a className="btn btn-outline-secondary scrollto" href="#about" data-toggle="modal"
            ...
            <section id="services" className="services section-bg">
                <div className="container">
                    ...
                    <TableInput numDays={numberOdDays} numHou={numberOfHours} city5Days={cities5Days}
                                cities={citiesCurrent} lisener={removeLisener}/>
                </div>
            </section>
            ...
            <section id="graph" className="featured">
                <div className="container">
                    <div className="section-title">
                        ...
                        <GraphInput timeList={listOfTime} citis5Days={cities5Days} hours={numberOfHours}
                                    days={numberOdDays} param={parametar}
                                    label={["pon" + numberOdDays, "pon", "pon", "pon", "pon", "pon", "pon", "pon", "pon", "pon", "pon", "pon"]}/>
                    </div>
                </div>
            </section>
            ...
            <div className="modal fade" id="exampleModalCenter" tabIndex="-1" role="dialog"
                ...
                <Settings numDays={numberOdDays} setNum={setNumberOfDays} numHours={numberOfHours}
                          setHours={setNumberOfHours} param={parametar} setParam={setPatametar}/></div>
        </div>
    );
}
